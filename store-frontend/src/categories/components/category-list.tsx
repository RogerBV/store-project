    ...
    <div className="w-full">
      <div className="mb-8">
        <div className="flex items-center justify_between">
            <div>
                <h1 className="text-3xl font-bold text-gray-900 mb-2">List of Categories</h1>
                <p className="text-gray-600">Manage the categories registered in the store</p>
            </div>
            <div className="flex items-center space-x-3">
                <div className="bg-blue-100 text-blue-800 px-4 py-2 rounded-full text-sm font-medium">
                    {categoriesParam.length} categories
                </div>
            </div>      
        </div>
        ...
        <div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
          <div className="flex items-center justify-between">
            <div className="text-sm text-gray-700">
              Showing <span className="font-medium">{categoriesParam.length}</span> de <span className="font-medium">{categoriesParam.length}</span> authors
            </div>
